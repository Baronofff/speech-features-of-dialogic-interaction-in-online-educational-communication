...
![Базовые распределения](basic_distributions.png)
...
![Тепловая карта корреляций](cramers_v_heatmap.png)
...
![Диаграмма состава кластеров](cluster_composition.png)
...
![PCA-визуализация кластеров](clusters_pca.png)
